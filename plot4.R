...
par(mfrow = c(2, 2))
par(mar = c(4, 4, 1, 1))
with(hh_pw1, plot(Date_Time, Global_active_power, ylab = "Global Active Power", 
                  xlab = "", type = "l"))
with(hh_pw1, plot(Date_Time, Voltage, ylab = "", xlab = "datetime", 
                  type = "l"))
...
with(hh_pw1, plot(Date_Time, Global_reactive_power, type = "l", 
